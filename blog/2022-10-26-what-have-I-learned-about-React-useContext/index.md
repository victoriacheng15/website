---
slug: what-have-i-learned-about-react-usecontext
title: What have I learned about React useContext?
authors: victoria
tags: [react, javascript]
hide_table_of_contents: false
---

![React Context API](react-series-useContext.png)
...
function Main() {
  ...
  // this is for the pagination that will display 12 countries each page
...
> Note: the `Main` component become a homepage that will display country cards, detailed country information page, and 404 error page. `Countries` component is under `page` folder.
